...
nb_train_samples = 10    #len(glob(train_data_dir + '/**/*.jpg', recursive=True)) // batch_size
nb_validation_samples = 30  #len(glob(validation_data_dir + '/**/*.jpg', recursive=True)) // batch_size
epochs = 1
